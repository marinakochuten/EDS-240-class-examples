...
#| out-width: "100%"
#.........................create caption.........................
github_icon <- "&#xf09b"  # &#x needed to tell ggplot that we are giving it a unicode - unicode came from font awesome
github_username <- "marinakochuten"
...
# <span> tag allows us to apply styling
...
subtitle <- glue::glue("<span style='font-family:fa-regular;'>{money_icon};</span>
                       ...
                       <span style='color:#2D7787;'>**male**</span> vs. 
                       <span style='color:#FC6B4B;'>**female**</span> workers by occupation in 2016")
...
```{r}
ggsave(filename = here::here("week6", "images", "salary_plot_14x12.png"),
       plot = plot,
       device = "png",
       width = 14,
       height = 12,
...
```{r}
ggsave(filename = here::here("week6", "images", "salary_plot_5x5.png"),
       plot = plot,
       device = "png",
       width = 5,
       height = 5,
